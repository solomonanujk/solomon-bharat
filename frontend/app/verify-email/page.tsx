  ...
  return (
    <div className="bg-bg min-h-screen flex items-center justify-center px-4 py-12">
      <div className="bg-surface border border-border-warm rounded p-8 w-full max-w-[420px] text-center">
        <Link href="/" className="font-display text-[22px] font-[700] text-primary leading-none block mb-8">
          Solomon Bharat
        </Link>

        {status === 'verifying' && (
          <>
            <h1 className="text-[22px] font-[600] font-display text-primary mb-1">Verifying your email…</h1>
            <p className="text-[14px] font-sans text-muted-text">One moment please.</p>
          </>
        )}

        {status === 'success' && (
          <>
            <h1 className="text-[22px] font-[600] font-display text-primary mb-2">Email verified</h1>
        ...
        {(status === 'error' || status === 'missing') && (
          <>
            <h1 className="text-[22px] font-[600] font-display text-primary mb-2">Verification link invalid</h1>
            <p className="text-[14px] font-sans text-muted-text leading-[1.5] mb-6">
              {status === 'missing'
