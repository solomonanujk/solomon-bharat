...
// ─── Page ──────────────────────────────────────────────────────────────────────
// The backend's SELLER application only accepts these six fields — no GST,
        ...
        <main className="flex-1 flex items-center justify-center px-4 py-16">
          <div className="max-w-[480px] w-full text-center flex flex-col items-center gap-4">
            ...
            <p className="font-public-sans text-[14px] text-muted-text leading-[1.7]">
              Thanks for applying to sell on Solomon Bharat. Our team will review your application
      ...
      <main className="flex-1">
        <div className="max-w-[560px] mx-auto w-full px-4 py-14 sm:py-20">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5" noValidate>
            ...
            <Button type="submit" variant="primary" size="lg" disabled={applyAsSeller.isPending} className="w-full mt-2">
