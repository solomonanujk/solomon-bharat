      ...
      <div className="flex-1 min-w-0 flex flex-col justify-between gap-3">
        <div>
          <Link
            ...
            className="text-[15px] font-[600] font-sans text-product-text leading-snug hover:underline"
          >
            {item.productName}
          </Link>
          {item.variantLabel && (
            <p className="text-[12px] font-sans text-muted-text mt-0.5">{item.variantLabel}</p>
          )}
          <div className="flex flex-wrap items-center gap-x-3 gap-y-1 mt-1.5">
            ...
            {item.leadTime && (
              <span className="inline-flex items-center gap-1 text-[12px] font-sans text-muted-text">
        ...
        <div className="flex items-center justify-between flex-wrap gap-3">
          <div className="flex items-center gap-3">
            <div className="flex items-center border border-border-warm rounded w-fit">
              ...
              <span className="w-10 text-center text-[13px] font-[600] font-sans text-primary select-none">
                {item.quantity}
              </span>
              <button
                type="button"
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 text-[12px] font-[600] font-sans text-muted-text hover:text-primary transition-colors"
            >
          ...
          <span className="text-[16px] font-[700] font-sans text-product-text">
            {fmt(lineTotal)}
          </span>
        </div>
      </div>
    ...
    <div className="bg-bg min-h-screen flex flex-col">
      ...
      <main className="flex-1 max-w-[1120px] mx-auto w-full px-4 sm:px-6 py-6 sm:py-10">
        <div className="flex items-center gap-4 mb-8">
          ...
          <h1 className="font-display font-[500] text-primary text-[24px] sm:text-[32px] leading-[1.1]">
