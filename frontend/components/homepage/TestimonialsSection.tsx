    ...
    <section className="py-16 lg:py-24 bg-bg tracking-[0.02em]">
      <div className="max-w-7xl mx-auto px-6 lg:px-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-10 lg:gap-16 items-start">
          ...
          {/* Featured quote — left */}
          <div>
            <p className="font-sans text-[12px] font-[500] text-accent uppercase tracking-[0.08em] mb-8">
              Buyer Reviews
            </p>

            {/* Big decorative quote mark */}
            <div
              className="font-display text-[80px] sm:text-[120px] lg:text-[160px] leading-[0.7] text-primary/[0.07] select-none mb-4"
              aria-hidden="true"
            >
              &ldquo;
            </div>
            ...
            <blockquote className="font-display font-[300] text-[18px] sm:text-[22px] lg:text-[28px] text-primary leading-[1.45] mt-5">
              {FEATURED.review}
            </blockquote>
            ...
            <div className="flex items-center gap-3 mt-8">
              ...
              />
              <div>
                <p className="font-display font-[400] text-[15px] text-primary">{FEATURED.name}</p>
                <p className="font-sans text-[12px] text-muted-text mt-0.5">
          ...
          <div className="flex flex-col gap-4">
            {OTHERS.map((t) => (
              <div key={t.name} className="bg-surface border border-border-warm rounded p-5">
                ...
                <p className="font-sans text-[13px] leading-[1.75] text-muted-text mt-3 mb-4">
                ...
                <div className="flex items-center gap-2.5 pt-4 border-t border-border-warm">
                  ...
                  <div className="min-w-0">
                    <p className="font-display font-[400] text-[13px] text-primary truncate">{t.name}</p>
                    <p className="font-sans text-[11px] text-muted-text truncate">
