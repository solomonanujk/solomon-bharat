    ...
    <section className="bg-[#3A2530] tracking-[0.02em]">
      <div className="max-w-[1400px] mx-auto px-5 sm:px-6 lg:px-16 py-10 sm:py-14">
        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6 md:gap-10 mb-8 sm:mb-10">
          <div>
            <p className="font-playfair italic font-[400] text-[#E8DE9A] text-[26px] sm:text-[32px] lg:text-[38px] leading-[1.15]">
              We&apos;re Solomon Bharat.
            </p>
            <p className="font-public-sans font-[600] text-white text-[18px] sm:text-[22px] lg:text-[26px] leading-[1.3] tracking-[0.05em] mt-1">
              The platform for retailers.
            </p>
          </div>
          <p className="font-public-sans font-[600] text-white text-[15px] sm:text-[17px] lg:text-[18px] leading-[1.4] max-w-[600px] tracking-[0.1em]">
