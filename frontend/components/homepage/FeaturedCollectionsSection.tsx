    ...
    <section className="py-12 bg-surface border-y border-border-warm tracking-[0.02em]">
      <div className="max-w-[1400px] mx-auto px-4 lg:px-10">
        ...
        <div className="flex items-baseline justify-between mb-10">
          ...
          <Link
            href="/collections"
            className="hidden sm:inline-flex items-center gap-1 font-public-sans text-[13px] font-[500] text-muted-text hover:text-primary transition-colors flex-shrink-0 ml-6"
          >
            ...
            {isLoading
              ...
              : collections.map((collection) => (
                  ...
                  >
                    ...
                    <div className="p-4">
                      <p className="font-playfair font-[400] text-primary text-[17px] leading-snug">
                        {collection.name}
                      </p>
