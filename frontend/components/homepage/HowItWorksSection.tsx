      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-16">
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="lg:w-[300px] xl:w-[340px] flex-shrink-0 lg:pr-12 pb-12 lg:pb-0 flex flex-col justify-between">
            <div>
              <p className="font-sans text-[12px] font-[500] text-accent uppercase tracking-[0.08em] mb-4">
                Simple Process
              </p>
              <h2 className="font-display font-[400] text-primary leading-[1.15] text-[28px] lg:text-[36px]">
                From Discovery<br /> to Delivery in<br /> Three Steps
              </h2>
            </div>
            <Link
              href="/"
              className="hidden lg:inline-flex items-center gap-1.5 font-sans text-[13px] font-[500] text-primary hover:text-accent transition-colors mt-10"
            >
          ...
          {STEPS.map(({ number, Icon, heading }) => (
            ...
            >
              {/* Step number */}
              <span className="font-display text-[52px] lg:text-[64px] font-[400] leading-none text-primary/[0.08] select-none block mb-3">
                {number}
              </span>
              ...
              <h3 className="font-display font-[400] text-[19px] text-primary leading-snug">
                {heading}
              </h3>
            </div>
          ))}
