  ...
  return (
    ...
    >
      <div className="flex items-center justify-between px-4 py-3 border-b border-border-warm">
        <p className="font-display text-[18px] font-[500] text-primary">Added to cart</p>
        <button
          type="button"
          onClick={hide}
          aria-label="Close"
      ...
      <div className="flex items-start gap-3 px-4 py-4">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="font-sans text-[13px] text-muted-text mt-1">Qty: {item.quantity}</p>
          <p className="font-sans text-[14px] font-[600] text-product-text mt-0.5">
